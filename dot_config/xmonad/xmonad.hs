...
myManageHook = composeAll
    ...
    , className =? "PokeMMO"          --> doShift (myWorkspaces !! 4)
...
myStartupHook = do
  spawnOnce "xrandr --output DP-0 --primary --mode 1920x1080 --rate 144 --right-of HDMI-0 --output HDMI-0 --mode 1920x1080 --rate 60 --output DVI-I-1-0 --off --output HDMI-0 --off"
